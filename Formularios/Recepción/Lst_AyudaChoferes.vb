...
Public Class Lst_AyudaChoferes
    ...
    Private Sub Lst_AyudaChoferes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        listar()
    End Sub
    ...
    Private Sub listar()
        ...
        If buscar <> "" Then
            sqlListar = "SELECT cho_rut, cho_nombre FROM Choferes WHERE cho_rutclie " & _
                        "LIKE '%" + buscar + "%' OR cho_nombre LIKE '%" + buscar + "%'"
        Else
            sqlListar = "SELECT cho_rut, cho_nombre FROM Choferes"
        End If
