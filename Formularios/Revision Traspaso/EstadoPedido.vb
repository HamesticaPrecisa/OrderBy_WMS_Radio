Public Class EstadoPedido
    ...
    Private Sub TxtRece_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtRece.KeyPress
        If e.KeyChar = ChrW(13) Then
            If TxtRece.Text.Length > 0 Then
                ...
                Dim sql As String = "SELECT RIGHT(pallet,2) AS PALLET, isnull(revisado,0) FROM pedidos_detalle WHERE pedido=(SELECT pedido FROM Pedidos_ficha WHERE Orden='" + TxtRece.Text + "')"
    ...
    Private Sub Frm_EstadoRevision_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Reset()
    End Sub
End Class